...
//! PATH string ⇄ TLV conversion + validation (Unit 2).
//!
...
/// Split a rooted path string (`"/sensor/temp"`) into its validated segments
...
/// Convert a rooted path string into a PATH TLV (`type=0x06`, `PL=1`).
...
/// Convert a PATH TLV back into its rooted string form (`"/sensor/temp"`). A PATH
