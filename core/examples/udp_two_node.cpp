...
int main() {
    ...
    tr::UdpTransport udp_a(kPortA, "127.0.0.1", kPortB);
    tr::UdpTransport udp_b(kPortB, "127.0.0.1", kPortA);
    ...
    tr::graph::Graph node_a;
    tr::graph::Graph node_b;
    tr::Bridge bridge_a(node_a, udp_a, peer_of(0xA1));
    tr::Bridge bridge_b(node_b, udp_b, peer_of(0xB2));
