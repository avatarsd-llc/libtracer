...
int main() {
    ...
    tr::net::udp_transport_t udp_a(kPortA, "127.0.0.1", kPortB);
    tr::net::udp_transport_t udp_b(kPortB, "127.0.0.1", kPortA);
    ...
    tr::net::bridge_t bridge_a(node_a, udp_a, peer_of(0xA1));
    tr::net::bridge_t bridge_b(node_b, udp_b, peer_of(0xB2));
