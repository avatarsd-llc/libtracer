 ...
 * `wire::key_view_t`'s, not ours: this used to hand-roll a near-verbatim copy of the
 * already-public `key_view_t::last_segment`, which is exactly the drift #888 is about.
 */
