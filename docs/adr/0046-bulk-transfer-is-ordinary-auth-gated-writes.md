...
- strawberry-fw deletes its OTA side-channel, discriminator framing, and `OtaChunkAck` machinery; the SPA's updater becomes a loop of SDK writes plus one subscription.
