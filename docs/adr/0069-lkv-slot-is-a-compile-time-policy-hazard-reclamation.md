...
> at `core/src/graph.cpp:838` under **no** lock. `vertex.hpp:1361` records the move in the
> source itself.
>
...
> member (`core/include/libtracer/graph.hpp:1137`) with **no in-tree caller**, whose retirement
