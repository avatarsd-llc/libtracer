...
- The `lkv_slot.hpp:581` relaxed-probe check-then-act (an orphan-push that can be missed even in the adoptable case) is a **separate genuine bug**, fixable independently of the policy seam.
