...
<div class="capm">
  ...
  <div class="capm-wrap"><table class="capm-table"><thead><tr><th>Integration</th><th>Kind</th><th>What it delivers</th><th>Build / CI</th><th>Status</th></tr></thead><tbody>
        ...
        <tr><td class="capm-name">Arduino</td><td>port / packaging</td><td class="capm-name" style="font-weight:400">packages core as an Arduino library</td><td data-s="na"><span class="capm-badge">—</span><span class="capm-note">not planned</span></td><td data-s="na"><span class="capm-badge">—</span><span class="capm-note">not planned</span></td></tr>
        <tr><td class="capm-name">PlatformIO</td><td>port / packaging</td><td class="capm-name" style="font-weight:400">ships + compiles the core (default portable set)</td><td data-s="warn"><span class="capm-badge">⚠️</span><span class="capm-note">pack-verified</span></td><td data-s="warn"><span class="capm-badge">⚠️</span><span class="capm-note">ships core; no pio consumer-build CI</span></td></tr>
