...
<div class="capm">
  ...
  <div class="capm-wrap"><table class="capm-table"><thead><tr><th>Module</th><th>Translation unit</th><th>Status</th></tr></thead><tbody>
        ...
        <tr><td class="capm-name">transport_i2c</td><td class="capm-name" style="font-weight:400"><code>—</code></td><td data-s="na"><span class="capm-badge">—</span><span class="capm-note">planned (catalog)</span></td></tr>
        <tr><td class="capm-name">transport_spi</td><td class="capm-name" style="font-weight:400"><code>—</code></td><td data-s="na"><span class="capm-badge">—</span><span class="capm-note">planned (catalog)</span></td></tr>
