...
| Bus-name rejection reply flatten (cold) | flatten `core/src/fwd_router.cpp:1034`, answered by the `wire::decode` opening `reject_bus_name_hop` | the frame is **dropped** by value — no reply |
