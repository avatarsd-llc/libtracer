...
`fwd_router_t::deliver_remote` (`core/src/fwd_router.cpp:1051`) is the sink the remote leg calls.
...
rope link (`fwd_router.cpp:1051-1010`). The header is a `stack_writer<16>` — the FWD header of at
