...
(`graph.cpp:2499`) pays one shared map hold that the handle overload does not.
...
array** (`graph.cpp:999-1000`, `vertex.hpp:2732`), so a subscriber added between the count and
