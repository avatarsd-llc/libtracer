...
- The FWD request terminus: `resolve_terminus_rope`
  (`core/include/libtracer/fwd_router.hpp:881-889`) adopts a fragmented request as
...
exhaustion drops the frame rather than throwing (`core/include/libtracer/fwd_router.hpp:933-941`,
[#596]).
...
everywhere smaller (`core/include/libtracer/fwd_router.hpp:862-865`, recorded as an erratum to
