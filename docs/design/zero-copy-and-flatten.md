...
(`integrations/esp-idf/libtracer/httpd_ws_link.cpp:75`, rationale and the 8 KB / ~12 KB figures at
...
- **WS reassembly (⑧)** regrows exact-size per fragment
  (`integrations/esp-idf/libtracer/httpd_ws_link.cpp:271-281`), which is O(n²) in total bytes
