...
value it names (`core/include/libtracer/vertex.hpp:79-82`), so a long-lived reference
...
(`core/include/libtracer/vertex.hpp:508`). The sugar takes the callable as `F&`
