...
(`graph_t::create_child`, `core/src/graph.cpp:2492-2519`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:393-397`). Retirement empties the
