...
(`graph_t::create_child`, `core/src/graph.cpp:3217-3244`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:550-554`). Retirement empties the
