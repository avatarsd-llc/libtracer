...
(`graph_t::create_child`, `core/src/graph.cpp:2409-2436`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:392-396`). Retirement empties the
