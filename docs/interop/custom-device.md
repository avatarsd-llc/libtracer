...
(`graph_t::create_child`, `core/src/graph.cpp:2533-2560`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:421-425`). Retirement empties the
