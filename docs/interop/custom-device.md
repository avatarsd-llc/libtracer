...
(`graph_t::create_child`, `core/src/graph.cpp:1758-1785`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:282-286`). Retirement empties the
