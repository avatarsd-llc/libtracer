...
(`graph_t::create_child`, `core/src/graph.cpp:2265-2292`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:385-389`). Retirement empties the
