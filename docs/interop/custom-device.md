...
(`graph_t::create_child`, `core/src/graph.cpp:3648-3675`). Reading `:children[]`
...
behind it (`core/include/libtracer/graph.hpp:676-680`). A connection is the exception:
