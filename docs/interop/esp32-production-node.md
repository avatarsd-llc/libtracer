...
(`core/include/libtracer/graph.hpp:472-475`) — and the **four** of
...
(`core/include/libtracer/graph.hpp:2122`), which snapshots four per-cause totals —
`no_target`, `denied`, `out_of_memory`, `fan_out_truncated` (`graph.hpp:2122-2144`). Each
