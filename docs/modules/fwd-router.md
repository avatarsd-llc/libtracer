...
hop (`core/src/transport_vertex.cpp:491-498,508-514`;
...
dedupe rather than a second source of truth (`core/src/transport_vertex.cpp:516-524`). Because a
...
`core/include/libtracer/transport_vertex.hpp:372`), a minting boundary gated by the shared
