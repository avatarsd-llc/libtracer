...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:987-988`, `:1007` for the
callable-by-address form, `:1020`).
```
...
(`core/include/libtracer/graph.hpp:777,864` by handle, `:1210,1216` by path;
