...
:class: important
`unsubscribe` **deactivates** the slot (`core/include/libtracer/graph.hpp:1811`); a
...
quiescent on return (`core/include/libtracer/graph.hpp:1769` states the bound on `ctx`).
```
...
(`core/include/libtracer/graph.hpp:1384,1590` by handle, `:2222,2228` by path;
