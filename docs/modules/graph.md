...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:1235-1236`, `:1255` for the
callable-by-address form, `:1268`).
```
...
(`core/include/libtracer/graph.hpp:1023,1110` by handle, `:1529,1535` by path;
`value_ref_t` at `core/include/libtracer/vertex.hpp:236`). A `value_ref_t` is an **owning
