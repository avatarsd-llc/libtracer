...
:class: important
`unsubscribe` **deactivates** the slot (`core/include/libtracer/graph.hpp:1617`); a
...
quiescent on return (`core/include/libtracer/graph.hpp:1575` states the bound on `ctx`).
```
...
(`core/include/libtracer/graph.hpp:1217,1396` by handle, `:1993,1999` by path;
