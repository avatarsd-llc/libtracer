...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:1067-1068`, `:1087` for the
callable-by-address form, `:1100`).
```
...
(`core/include/libtracer/graph.hpp:857,944` by handle, `:1300,1306` by path;
