...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:1183-1184`, `:1203` for the
callable-by-address form, `:1216`).
```
...
(`core/include/libtracer/graph.hpp:971,1058` by handle, `:1458,1464` by path;
