...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:786-788`, `:802` for the
callable-by-address form, `:819-824`).
```
...
(`core/include/libtracer/graph.hpp:576,663` by handle, `:967,973` by path;
