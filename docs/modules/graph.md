...
the `unsubscribe` call (`core/include/libtracer/graph.hpp:838-839`, `:858` for the
callable-by-address form, `:871`).
```
...
(`core/include/libtracer/graph.hpp:628,715` by handle, `:1019,1025` by path;
