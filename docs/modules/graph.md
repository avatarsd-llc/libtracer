...
:class: important
`unsubscribe` **deactivates** the slot (`core/include/libtracer/graph.hpp:1508`); a
...
quiescent on return (`core/include/libtracer/graph.hpp:1466` states the bound on `ctx`).
```
...
(`core/include/libtracer/graph.hpp:1197,1294` by handle, `:1881,1887` by path;
