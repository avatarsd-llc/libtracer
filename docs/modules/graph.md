...
:class: important
`unsubscribe` **deactivates** the slot (`core/include/libtracer/graph.hpp:1435`); a
...
quiescent on return (`core/include/libtracer/graph.hpp:1393` states the bound on `ctx`).
```
...
(`core/include/libtracer/graph.hpp:1134,1221` by handle, `:1796,1802` by path;
