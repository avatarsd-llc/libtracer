...
| [graph](graph.md) | `class graph_t{ register_vertex; read; write; await; history; subscribe; subscribe_wire(vertex_t*, view_t source_view, …) }` · `enum class role_t` · `struct settings_t` · `struct handlers_t` |
