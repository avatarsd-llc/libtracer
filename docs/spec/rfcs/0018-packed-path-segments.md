...
`COMPACT`, and the `COMPACT` terminus **never** replies (`core/src/fwd_router.cpp:1057-1091`).
...
`resolve_route_vertex` (`core/src/fwd_router.cpp:1153-1155`) resolves an ADVERTISE route, so a peer
