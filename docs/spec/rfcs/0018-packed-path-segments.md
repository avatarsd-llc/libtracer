...
(`core/src/op_resolve_walk.hpp:753-758`) which then routes four hops home. `chain-label` injects
...
- `path_lookup_key`'s re-emit fallback (`core/src/op_resolve_walk.hpp:558-570`), whose fast path
