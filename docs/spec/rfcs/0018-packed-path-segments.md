...
(`core/src/op_resolve_walk.hpp:841-846`) which then routes four hops home. `chain-label` injects
...
- `path_lookup_key`'s re-emit fallback (`core/src/op_resolve_walk.hpp:646-658`), whose fast path
