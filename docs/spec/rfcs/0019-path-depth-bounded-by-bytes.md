...
structurally" (`core/include/libtracer/graph.hpp:723-729`, `core/src/graph.cpp:1905`).
...
- Comment-only sites needing the corrected wording: `core/include/libtracer/graph.hpp:723-729`,
