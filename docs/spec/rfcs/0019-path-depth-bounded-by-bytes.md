...
structurally" (`core/include/libtracer/graph.hpp:663-669`, `core/src/graph.cpp:1896`).
...
- Comment-only sites needing the corrected wording: `core/include/libtracer/graph.hpp:663-669`,
