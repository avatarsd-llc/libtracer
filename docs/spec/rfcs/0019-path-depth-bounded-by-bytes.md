...
structurally" (`core/include/libtracer/graph.hpp:729-735`, `core/src/graph.cpp:1905`).
...
- Comment-only sites needing the corrected wording: `core/include/libtracer/graph.hpp:729-735`,
