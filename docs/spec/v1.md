...
- _unreleased_ — §3 and §3.1.2: the canonical PATH segment cap is repriced from 32 to 255, and the encode-time limits sentence gains the informative note that the byte budget binds first ([RFC-0023](rfcs/0023-path-segment-cap-repriced-32-to-255.md)).
