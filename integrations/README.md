...
| [platformio/](platformio/) | `registry.platformio.org` (`pio pkg publish`) | library ships + compiles the default core source set (codec + graph + tcp/udp/ws/can; CUDA/QUIC/WebTransport are opt-in and filtered out) |
