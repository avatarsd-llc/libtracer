...
('core/include/libtracer/graph.hpp:1058',
    ...
    ('core/include/libtracer/vertex.hpp:1409', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:2205', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2222', '++drops.out_of_memory;'),
    ...
    ('core/include/libtracer/vertex.hpp:1459',
    ...
    ('core/include/libtracer/vertex.hpp:1467',
     'if (!pin.valid()) {  // domain exhausted: the pre-#635 path, for these threads only'),
    ('core/include/libtracer/vertex.hpp:2141',
     '*        displaced one. Call with the stripe lock held; the caller runs'),
    ('core/include/libtracer/vertex.hpp:2305', 'const std::size_t doff = off;'),
    ('core/include/libtracer/vertex.hpp:2382',
