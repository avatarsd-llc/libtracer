...
ANCHORS = [
    ...
    ("core/src/fwd_router.cpp:1623", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1652", "value.materialize(*flat_)"),
    ("core/src/fwd_router.cpp:1653", "flatten OOM"),
    ("core/src/fwd_router.cpp:1657", "try_encode_compact", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1689", "std::vector<std::span<const std::byte>> iov;", "fwd_router_t::deliver_remote"),
    ...
    ("core/src/fwd_router.cpp:1304", "route_flat.empty()"),
    ("core/src/fwd_router.cpp:1324", "payload_flat.empty()"),
    ("core/src/fwd_router.cpp:1317", "frame.subrope(head->child1_off, head->child1_total).materialize", "case type_t::COMPACT"),
    ("core/src/fwd_router.cpp:918", "frame.subrope(0, frame.total_length()).materialize"),
    ...
    ("core/src/fwd_router.cpp:1222", "decode_into(frame, rx_for(inbound_ctx))"),
    ...
    ('core/src/fwd_router.cpp:869',
     'void fwd_router_t::on_frame_rope_impl(std::string_view inbound_name, view::rope_t frame,'),
    ('core/src/fwd_router.cpp:875', 'if (frame.link_count() == 1) {'),
    ('core/src/fwd_router.cpp:936', '// A REPLY that reaches its originator here is handed to the sink rope-native'),
    ('core/src/fwd_router.cpp:1270',
     'void fwd_router_t::on_control_rope(std::string_view inbound_name, view::rope_t frame) {'),
    ('core/src/fwd_router.cpp:1283', 'const auto head = peek_control(cur, wire::grammar::crc_check_t::VERIFY);'),
    ('core/src/fwd_router.cpp:1296', 'const view_t route_flat ='),
    ...
    ('core/src/fwd_router.cpp:1638', "// dropped fresh ADVERTISE self-heals via the peer's HANDLE_NACK (§E.1)."),
    ('core/src/fwd_router.cpp:1673',
