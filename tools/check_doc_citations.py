...
('core/include/libtracer/graph.hpp:1058',
    ...
    ('core/include/libtracer/vertex.hpp:711', '[[nodiscard]] bool has_registered_child() const noexcept {'),
    ('core/include/libtracer/vertex.hpp:1403', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:2199', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2216', '++drops.out_of_memory;'),
    ...
    ('core/include/libtracer/vertex.hpp:1461',
     'if (!pin.valid()) {  // domain exhausted: the pre-#635 path, for these threads only'),
    ('core/include/libtracer/vertex.hpp:2135',
     '*        displaced one. Call with the stripe lock held; the caller runs'),
    ('core/include/libtracer/vertex.hpp:2299', 'const std::size_t doff = off;'),
    ('core/include/libtracer/vertex.hpp:2376',
