...
ANCHORS = [
    ...
    ("core/include/libtracer/fwd_router.hpp:1080", "Terminus over a MULTI-LINK rope"),
    ("core/include/libtracer/fwd_router.hpp:1086", "64 KB / 2 links"),
    ("core/include/libtracer/fwd_router.hpp:1132", "The forward hop, read entirely by OFFSET"),
    ...
    ("core/src/op_resolve_walk.hpp:984", 'field.steps[0].name != "subscribers"'),
    ...
    ('core/src/op_resolve_walk.hpp:1050', 'if (!req.dst.spans_intact()) return reply_error(status_t::BACKPRESSURE);'),
    ...
    ("core/src/fwd_router.cpp:2700", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:2738", "value.try_materialize(*flat_)"),
    ("core/src/fwd_router.cpp:2739", "if (!flat) return;", "A REFUSED materialize drops the delivery"),
    ("core/src/fwd_router.cpp:2741", "emit_compact", "fwd_router_t::deliver_remote"),
    ...
    ("core/src/fwd_router.cpp:2194", "if (route.empty() && head->child1_total != 0) return;"),
    ("core/src/fwd_router.cpp:2213", "if (payload.empty() && head->child1_total != 0) return;"),
    ("core/src/fwd_router.cpp:2206", "const std::span<const std::byte> payload = contig(head->child1_off, head->child1_total);"),
    ...
    ("core/src/fwd_router.cpp:2112", "decode_into(frame, rx_for(inbound_ctx))"),
    ...
    ('core/include/libtracer/fwd_router.hpp:1467',
...
('core/include/libtracer/graph.hpp:1164',
    ...
    ('core/src/fwd_router.cpp:2222',
     'void fwd_router_t::on_control_rope(std::string_view inbound_name, view::rope_t frame) {'),
    ('core/src/fwd_router.cpp:2173', 'const auto head = peek_control(cur, wire::grammar::crc_check_t::VERIFY);'),
    ('core/src/fwd_router.cpp:2187', 'const std::span<const std::byte> route = contig(head->child1_off, head->child1_total);'),
    ('core/src/fwd_router.cpp:2237', 'frame.subrope(off, total).try_materialize(*flat_);'),
    ('core/src/fwd_router.cpp:2717',
     "// else. A dropped fresh ADVERTISE self-heals via the peer's HANDLE_NACK (§E.1). NOT yet"),
    ('core/src/fwd_router.cpp:2798',
    ...
    ('core/src/op_resolve_walk.hpp:938',
    ...
    ('core/src/fwd_router.cpp:2090',
     'mem::block_array_t<std::span<const std::byte>> iov{rx_for(inbound_ctx)};'),
    ('core/src/fwd_router.cpp:2227',
     'const wire::grammar::rope_cursor cur{frame};',
     'if (!frame.all_host()) return;'),
    ('core/src/fwd_router.cpp:2487', 'const auto payload_view = view::over_bytes(payload_bytes);'),
