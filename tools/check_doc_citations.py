...
ANCHORS = [
    ...
    ("core/src/graph.cpp:3482", "Everything else under `settings`"),
    ("core/src/graph.cpp:3680", "result_t<view_t> graph_t::read_settings(vertex_t* v) const {"),
    ...
    ("core/src/graph.cpp:3261", "sel == field_sel_t::TAIL", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:3381", "!whole_field(field)", 'step0.name == "acl"'),
    ("core/src/graph.cpp:3421", "field_selector(field) != field_sel_t::APPEND"),
    ("core/src/graph.cpp:3315", "sel == field_sel_t::WILDCARD"),
    ("core/src/graph.cpp:3857", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ...
    ("core/src/graph.cpp:2021", "void graph_t::fan_out"),
    ("core/src/graph.cpp:2200", "graph_t::write_impl"),
    ("core/src/graph.cpp:2340", "value.try_materialize(*value_backend_)", "graph_t::write_branch"),
    ("core/src/graph.cpp:2342", "flatten_err_t::NO_MEMORY", "graph_t::write_branch"),
    ("core/src/graph.cpp:2357", "std::array<std::byte, 4096> stack;"),
    ("core/src/graph.cpp:2358", "bump_source_t src(stack"),
    ("core/src/graph.cpp:2360", "decode_into(head->bytes(), src)"),
    ("core/src/graph.cpp:2376", "std::vector<std::byte> root_key;"),
    ("core/src/graph.cpp:2377", "try_build_key(v, root_key)"),
    ("core/src/graph.cpp:2382", "try_assign(parse_key, root_key)"),
    ("core/src/graph.cpp:2700", "value.try_materialize(*value_backend_)",
     "field_write read an empty head"),
    ("core/src/graph.cpp:3233", "result_t<void> graph_t::field_write"),
    ("core/src/graph.cpp:3423", "acl_right_t::CREATE", 'step0.name == "children"'),
...
('core/include/libtracer/graph.hpp:1545',
    ...
    ('core/src/graph.cpp:3191', 'delivery_link.assign(split.link);'),
    ...
    ('core/src/graph.cpp:2081', '// nested publish must not be able to swallow this tally).'),
    ('core/src/graph.cpp:2339',
    ...
    ('core/src/graph.cpp:2385', 'if (!parsed) return std::unexpected(parsed.error());'),
    ('core/src/graph.cpp:2542', 'if (!detail::try_assign(copy, k)) return false;'),
    ('core/src/graph.cpp:2639',
     '// Empty-set fast path (the per-eager-write case when nobody uses assign+propagate):'),
    # ('core/src/graph.cpp:2770', '// status (ADR-0060 §3), …') — anchor DROPPED (#1271). It
    ...
    ('core/src/graph.cpp:3323', 'if (!tlv) return std::unexpected(status_t::TYPE_MISMATCH);'),
    ('core/src/graph.cpp:3494',
