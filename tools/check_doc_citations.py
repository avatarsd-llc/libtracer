...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2008", "graph_t::set_identity"),
    ("core/src/graph.cpp:2034", "graph_t::read_identity"),
    ("core/src/graph.cpp:2416", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:1816", "field.steps.size() != 1 || !plain_step(step0)"),
    ("core/src/graph.cpp:1853", "field.steps.size() != 1", 'step0.name == "children"'),
    ("core/src/graph.cpp:1759", "step0.wildcard"),
    ("core/src/graph.cpp:2174", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2220", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2232", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2349", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2386", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2382", '"children" && !field.steps[0].wildcard'),
    ("core/src/graph.cpp:2482", "!field.steps[0].wildcard", 'field.steps[0].name == "subscribers"'),
...
('core/include/libtracer/graph.hpp:857',
    ...
    ('core/src/graph.cpp:1910', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2513', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
