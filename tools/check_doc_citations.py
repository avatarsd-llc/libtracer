...
('core/include/libtracer/graph.hpp:1361',
    ...
    ('core/tests/CMakeLists.txt:1657', 'add_executable(substrate_test_no_atomic'),
    ('core/tests/CMakeLists.txt:1672', 'target_compile_definitions(substrate_test_no_atomic PRIVATE'),
    ('core/tests/CMakeLists.txt:1673', '    LIBTRACER_NO_ATOMIC'),
