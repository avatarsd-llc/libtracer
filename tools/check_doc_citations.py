...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2260", "graph_t::set_identity"),
    ("core/src/graph.cpp:2286", "graph_t::read_identity"),
    ("core/src/graph.cpp:2705", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:1941", "sel == field_sel_t::TAIL", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:2060", "!whole_field(field)", 'step0.name == "acl"'),
    ("core/src/graph.cpp:2100", "field_selector(field) != field_sel_t::APPEND"),
    ("core/src/graph.cpp:1994", "sel == field_sel_t::WILDCARD"),
    ("core/src/graph.cpp:2426", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2472", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2484", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2601", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2642", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2639", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:2785", "field_selector(field) == field_sel_t::SLOT"),
    ...
    ('core/include/libtracer/graph.hpp:1342', 'struct delivery_drops_t {'),
    ('core/include/libtracer/graph.hpp:1344', 'std::uint64_t no_target = 0;'),
    ('core/include/libtracer/graph.hpp:1346', 'std::uint64_t denied = 0;'),
    ('core/include/libtracer/graph.hpp:1349', 'std::uint64_t out_of_memory = 0;'),
    ('core/include/libtracer/graph.hpp:1353', 'std::uint64_t fan_out_truncated = 0;'),
    ('core/include/libtracer/graph.hpp:1364', '[[nodiscard]] delivery_drops_t delivery_drops() const noexcept;'),
    ('core/include/libtracer/graph.hpp:1406', 'void fan_out(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1412', 'void dispatch_edge(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1418', 'void dispatch_edge_target(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1419', 'void dispatch_edge_remote(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1436', 'void bubble_up(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1440', 'void deliver_vertex(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1618', 'std::pmr::memory_resource* mr_ = std::pmr::get_default_resource();'),
    ('core/include/libtracer/graph.hpp:1627', 'mem::mem_backend_t* value_backend_ = &mem::heap_backend();'),
    ('core/include/libtracer/graph.hpp:1695', 'mem::block_source_t* ctl_ = &mem::heap_source();'),
    ...
    ("core/src/graph.cpp:1913", "result_t<void> graph_t::field_write"),
    ("core/src/graph.cpp:2102", "acl_right_t::CREATE", 'step0.name == "children"'),
    ("core/src/fwd_router.cpp:1917", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1955", "value.try_materialize(*flat_)"),
    ("core/src/fwd_router.cpp:1956", "if (!flat) return;", "A REFUSED materialize drops the delivery"),
    ("core/src/fwd_router.cpp:1958", "emit_compact", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1989", "std::vector<std::span<const std::byte>> iov;", "fwd_router_t::deliver_remote"),
...
('core/include/libtracer/graph.hpp:893',
    ...
    ('core/include/libtracer/graph.hpp:1686',
     '*         to migrate. Kept a DIFFERENT type from `mr_` on purpose (see'),
    ('core/include/libtracer/graph.hpp:1689',
    ...
    ('core/src/graph.cpp:2170', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2816', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/src/graph.cpp:1899', 's.target_key.reset();'),
