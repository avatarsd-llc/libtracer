...
ANCHORS = [
    ...
    ("core/src/graph.cpp:1994", "graph_t::set_identity"),
    ("core/src/graph.cpp:2020", "graph_t::read_identity"),
    ("core/src/graph.cpp:2402", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:1802", "field.steps.size() != 1 || !plain_step(step0)"),
    ("core/src/graph.cpp:1839", "field.steps.size() != 1", 'step0.name == "children"'),
    ("core/src/graph.cpp:1748", "step0.wildcard"),
    ("core/src/graph.cpp:2160", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2206", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2218", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2335", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2372", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2368", '"children" && !field.steps[0].wildcard'),
    ("core/src/graph.cpp:2468", "!field.steps[0].wildcard", 'field.steps[0].name == "subscribers"'),
    ...
    ("core/src/graph.cpp:1841", "acl_right_t::CREATE", 'step0.name == "children"'),
...
('core/include/libtracer/graph.hpp:857',
    ...
    ('core/src/graph.cpp:1896', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2499', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
