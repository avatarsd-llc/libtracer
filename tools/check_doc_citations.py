...
ANCHORS = [
    ...
    ('core/include/libtracer/graph.hpp:1914', 'mem::mem_backend_t* value_backend_ = &mem::heap_backend();'),
    ('core/include/libtracer/graph.hpp:2003', 'mem::block_source_t* ctl_ = &mem::heap_source();'),
...
('core/include/libtracer/graph.hpp:1023',
    ...
    ('core/include/libtracer/graph.hpp:1994',
     '*         to migrate. Kept a DIFFERENT type from `mr_` on purpose (see'),
    ('core/include/libtracer/graph.hpp:1997',
