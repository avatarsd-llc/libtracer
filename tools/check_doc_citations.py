...
('core/include/libtracer/graph.hpp:1361',
    ...
    ('core/tests/CMakeLists.txt:1653', 'add_executable(substrate_test_no_atomic'),
    ('core/tests/CMakeLists.txt:1668', 'target_compile_definitions(substrate_test_no_atomic PRIVATE'),
    ('core/tests/CMakeLists.txt:1669', '    LIBTRACER_NO_ATOMIC'),
