...
ANCHORS = [
    ...
    ("core/src/fwd_router.cpp:1615", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1644", "value.materialize(*flat_)"),
    ("core/src/fwd_router.cpp:1645", "flatten OOM"),
    ("core/src/fwd_router.cpp:1649", "try_encode_compact", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1681", "std::vector<std::span<const std::byte>> iov;", "fwd_router_t::deliver_remote"),
    ...
    ("core/src/fwd_router.cpp:1296", "route_flat.empty()"),
    ("core/src/fwd_router.cpp:1316", "payload_flat.empty()"),
    ("core/src/fwd_router.cpp:1309", "frame.subrope(head->child1_off, head->child1_total).materialize", "case type_t::COMPACT"),
    ...
    ("core/src/fwd_router.cpp:1214", "decode_into(frame, rx_for(inbound_ctx))"),
    ...
    ('core/src/fwd_router.cpp:1262',
     'void fwd_router_t::on_control_rope(std::string_view inbound_name, view::rope_t frame) {'),
    ('core/src/fwd_router.cpp:1275', 'const auto head = peek_control(cur, wire::grammar::crc_check_t::VERIFY);'),
    ('core/src/fwd_router.cpp:1288', 'const view_t route_flat ='),
    ('core/src/fwd_router.cpp:1289',
    ...
    ('core/src/fwd_router.cpp:1630', "// dropped fresh ADVERTISE self-heals via the peer's HANDLE_NACK (§E.1)."),
    ('core/src/fwd_router.cpp:1665',
