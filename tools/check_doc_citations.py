...
('core/include/libtracer/graph.hpp:1295',
    ...
    ('core/include/libtracer/subscriber.hpp:108', 'using subscriber_fn_t = void (*)(void* ctx, const rope_t& value);'),
    ('core/include/libtracer/subscriber.hpp:548', 'class edge_snapshot_t {'),
    ('core/include/libtracer/subscriber.hpp:551', 'static constexpr std::size_t kCapacity = 8;'),
    ...
    ('core/include/libtracer/vertex.hpp:2264', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2281', '++drops.out_of_memory;'),
    ...
    ('core/include/libtracer/subscriber.hpp:73', 'struct delivery_policy_t {'),
    ('core/include/libtracer/vertex.hpp:385', 'enum class delivery_mode_t : std::uint8_t {'),
    ('core/include/libtracer/subscriber.hpp:637', 'struct alignas(pub_edge_t) edge_pub_t {'),
    ('core/include/libtracer/subscriber.hpp:740',
    ...
    ('core/include/libtracer/vertex.hpp:2368', 'const std::size_t doff = off;'),
    ('core/include/libtracer/vertex.hpp:2445',
