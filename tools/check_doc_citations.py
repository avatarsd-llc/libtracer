...
('core/include/libtracer/graph.hpp:857',
    ...
    ('core/include/libtracer/transport_can.hpp:348', '[[nodiscard]] bus_link_t* bus() override { return this; }'),
    ('core/include/libtracer/transport_can.hpp:367',
    ...
    ('core/src/transport_can.cpp:286', 'tr::view::view_can_frames_t::split(*payload, cfg_.mode);'),
]
