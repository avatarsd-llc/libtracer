...
('core/include/libtracer/graph.hpp:857',
    ...
    ('core/include/libtracer/vertex.hpp:1917', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:1967',
     'std::size_t snapshot_edges(edge_snapshot_t& inline_buf, std::vector<edge_view_t>& overflow,'),
    ('core/include/libtracer/vertex.hpp:2678', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2684',
     '// OOM fallback (reserve failed on a wide list): the inline prefix delivers,'),
    ('core/include/libtracer/vertex.hpp:2690',
     'if (src[i].active.load(std::memory_order_acquire)) ++drops.truncated;'),
    ('core/include/libtracer/vertex.hpp:2695', '++drops.out_of_memory;'),
