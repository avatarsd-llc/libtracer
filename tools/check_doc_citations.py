...
ANCHORS = [
    ...
    ("core/src/op_resolve_walk.hpp:350", "enum class index_mode_t"),
    ("core/src/op_resolve_walk.hpp:927", 'field.steps[0].name != "subscribers"'),
    ("core/src/op_resolve_walk.hpp:163", "view_t own_wire(mem::mem_backend_t& flat)"),
    ("core/src/op_resolve_walk.hpp:549", "rope_t or_backpressure"),
...
('core/include/libtracer/graph.hpp:1164',
    ...
    ('core/src/op_resolve_walk.hpp:799',
