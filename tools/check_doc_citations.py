...
ANCHORS = [
    ...
    ("core/src/graph.cpp:1794", "graph_t::set_identity"),
    ("core/src/graph.cpp:1820", "graph_t::read_identity"),
    ("core/src/graph.cpp:2178", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:2144", '"children" && !field.steps[0].wildcard'),
    ("core/src/graph.cpp:2222", "!field.steps[0].wildcard", 'field.steps[0].name == "subscribers"'),
    ...
    ("core/src/graph.cpp:1054", "!arena"),
    ("core/include/libtracer/segment.hpp:78", "struct segment_t"),
    # --- the design + module pages (#728). Every one of these had drifted. ---
    ("core/src/graph.cpp:753", "has_registered_child()"),
    ("core/src/graph.cpp:843", "void graph_t::fan_out"),
    ("core/src/graph.cpp:975", "graph_t::write_impl"),
    ("core/src/graph.cpp:1037", "value.materialize(*value_backend_)", "graph_t::write_branch"),
    ("core/src/graph.cpp:1038", "head.empty() && value.total_length()", "graph_t::write_branch"),
    ("core/src/graph.cpp:1050", "std::array<std::byte, 4096> stack;"),
    ("core/src/graph.cpp:1051", "bump_source_t src(stack"),
    ("core/src/graph.cpp:1053", "decode_into(head.bytes(), src)"),
    ("core/src/graph.cpp:1069", "std::vector<std::byte> root_key;"),
    ("core/src/graph.cpp:1070", "try_build_key(v, root_key)"),
    ("core/src/graph.cpp:1072", "try_assign(parse_key, root_key)"),
    ("core/src/graph.cpp:1274", "value.materialize(*value_backend_)", "field_write read it back"),
