...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2611", "graph_t::set_identity"),
    ("core/src/graph.cpp:2645", "graph_t::read_identity"),
    ("core/src/graph.cpp:3069", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:2790", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2836", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2848", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2965", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:3006", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:3003", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:3149", "field_selector(field) == field_sel_t::SLOT"),
    ...
    ('core/include/libtracer/graph.hpp:2023', 'mem::block_source_t* ctl_ = &mem::heap_source();'),
...
('core/include/libtracer/graph.hpp:1058',
    ...
    ('core/include/libtracer/graph.hpp:2014',
     '*         to migrate. Kept a DIFFERENT type from `mr_` on purpose (see'),
    ('core/include/libtracer/graph.hpp:2017',
    ...
    ('core/src/graph.cpp:3180', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/src/graph.cpp:2663', 'result_t<view_t> graph_t::read_settings(vertex_t* v) const {'),
