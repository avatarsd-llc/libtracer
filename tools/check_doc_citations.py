...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2012", "graph_t::set_identity"),
    ("core/src/graph.cpp:2038", "graph_t::read_identity"),
    ("core/src/graph.cpp:2420", 'field.steps[0].name == "identity"'),
    ("core/src/transport_vertex.cpp:58", 'cfg.name("kind")'),
    ("core/src/transport_vertex.cpp:93", "register_child_type"),
    ("core/src/transport_vertex.cpp:122", "register_transport_type"),
    ("core/src/transport_vertex.cpp:127", "transport_vertex_t::register_module"),
    ("core/src/transport_vertex.cpp:161", "SCHEMA_NOT_FOUND", "transport_vertex_t::module_for"),
    ...
    ("core/src/transport_vertex.cpp:164", "transport_vertex_t::provide_link"),
    ("core/src/transport_vertex.cpp:217", "routing key IS the mount path"),
    ("core/src/transport_vertex.cpp:224", "qualified += name"),
    ("core/src/transport_vertex.cpp:243", "grouping vertex, created lazily"),
    ("core/src/transport_vertex.cpp:251", "register_vertex_key(mod_key"),
    ("core/src/transport_vertex.cpp:341", "if (!router_.add_child(qualified, *link))"),
    ("core/src/transport_vertex.cpp:344", "return std::unexpected(status_t::BACKPRESSURE);",
     "if (!router_.add_child(qualified, *link))"),
    ("core/src/transport_vertex.cpp:350", "pending_links_.erase(pl)"),
    ("core/src/transport_vertex.cpp:364", "if (constructed)"),
    ("core/src/transport_vertex.cpp:366", "link_state_t::LISTENING : link_state_t::UP"),
    ...
    ("core/src/graph.cpp:1723", "field.steps.size() != 1", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:1820", "field.steps.size() != 1 || !plain_step(step0)"),
    ("core/src/graph.cpp:1857", "field.steps.size() != 1", 'step0.name == "children"'),
    ("core/src/graph.cpp:1763", "step0.wildcard"),
    ("core/src/graph.cpp:2178", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2224", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2236", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2353", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2390", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2386", '"children" && !field.steps[0].wildcard'),
    ("core/src/graph.cpp:2486", "!field.steps[0].wildcard", 'field.steps[0].name == "subscribers"'),
    ...
    ("core/src/fwd_router.cpp:1419", "route_flat.empty()"),
    ("core/src/fwd_router.cpp:1439", "payload_flat.empty()"),
    ("core/src/fwd_router.cpp:1432", "frame.subrope(head->child1_off, head->child1_total).materialize", "case type_t::COMPACT"),
    ("core/src/fwd_router.cpp:1031", "frame.subrope(0, frame.total_length()).materialize"),
    ...
    ("core/src/fwd_router.cpp:1337", "decode_into(frame, rx_for(inbound_ctx))"),
...
('core/include/libtracer/graph.hpp:857',
    ...
    ('core/src/fwd_router.cpp:515',
     'bool fwd_router_t::add_child(std::string name, transport_t& link, mem::block_source_t* rx) {'),
    ('core/src/fwd_router.cpp:980',
     'void fwd_router_t::on_frame_rope_impl(std::string_view inbound_name, view::rope_t frame,'),
    ('core/src/fwd_router.cpp:986', 'if (frame.link_count() == 1) {'),
    ('core/src/fwd_router.cpp:1049', '// A REPLY that reaches its originator here is handed to the sink rope-native'),
    ('core/src/fwd_router.cpp:1385',
     'void fwd_router_t::on_control_rope(std::string_view inbound_name, view::rope_t frame) {'),
    ('core/src/fwd_router.cpp:1398', 'const auto head = peek_control(cur, wire::grammar::crc_check_t::VERIFY);'),
    ('core/src/fwd_router.cpp:1411', 'const view_t route_flat ='),
    ('core/src/fwd_router.cpp:1412',
    ...
    ('core/src/graph.cpp:1394',
     'result_t<void> graph_t::write(vertex_handle_t v, rope_t value, std::string_view caller) {'),
    ('core/src/graph.cpp:1914', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2517', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/src/transport_vertex.cpp:47',
     '*        NAME <utf8>, NAME "kind" NAME <utf8>, NAME "port" VALUE u16, NAME "role" VALUE u8'),
    ('core/src/transport_vertex.cpp:68', '[[nodiscard]] view_t link_state_value(link_state_t state) {'),
    ('core/src/transport_vertex.cpp:97',
     'graph_.register_child_type(',
     'return make_connection(std::move(key), config, conn_role_t::DIAL);'),
    ('core/src/transport_vertex.cpp:143',
     'result_t<std::string> transport_vertex_t::module_for(std::string_view kind,'),
    ('core/src/transport_vertex.cpp:197', 'std::string staged_key;'),
    ...
    ('core/src/fwd_router.cpp:622', 'link.set_rope_receiver('),
    ('core/src/fwd_router.cpp:576', 'bus->set_peer_rope_receiver('),
    ...
    ('core/src/graph.cpp:1687', 's.target_key.reset();'),
