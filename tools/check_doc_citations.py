...
ANCHORS = [
    ...
    ('core/include/libtracer/fwd_router.hpp:147',
     'std::pmr::memory_resource* mr = std::pmr::get_default_resource(),'),
    ('core/include/libtracer/fwd_router.hpp:148', 'mem::block_source_t* rx = &mem::heap_source(),'),
    ('core/include/libtracer/fwd_router.hpp:149', 'mem::mem_backend_t* flat = &mem::heap_backend(),'),
    ('core/include/libtracer/fwd_router.hpp:281',
     "* Invoked (with the `FWD{REPLY}` frame as a @ref view::rope_t) when a REPLY's first"),
    ('core/include/libtracer/fwd_router.hpp:617',
    ...
    ('core/include/libtracer/mem_heap.hpp:266',
    ...
    ('core/src/op_resolve_walk.hpp:237', 'parsed_fwd_t<N> p;'),
    ('core/src/op_resolve_walk.hpp:456',
     'void tlv_sliced(std::span<const std::byte> wire) {  // trailer-sliced whole-TLV copy (§4)'),
    ('core/src/op_resolve_walk.hpp:509', 'out.tlv_sliced(reply_dst_wire);'),
    ('core/src/op_resolve_walk.hpp:654',
     'if (!req.src.spans_intact()) return std::unexpected(status_t::BACKPRESSURE);'),
    ('core/src/op_resolve_walk.hpp:699', 'if (!req.dst.spans_intact()) return reply_error(status_t::BACKPRESSURE);'),
    ('core/src/op_resolve_walk.hpp:813', 'if (value.total_length() == 0)'),
    # core/src/path.cpp
