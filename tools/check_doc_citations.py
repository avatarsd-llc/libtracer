...
ANCHORS = [
    ...
    ("core/src/graph.cpp:1851", "graph_t::set_identity"),
    ("core/src/graph.cpp:1877", "graph_t::read_identity"),
    ...
    ("core/include/libtracer/child_registry.hpp:281", "entry_by_name"),
    ("core/include/libtracer/child_registry.hpp:302", "by_name"),
    ("core/include/libtracer/child_registry.hpp:343", "std::size_t size()"),
    ("core/include/libtracer/child_registry.hpp:353", "live_size"),
    ...
    ("core/src/graph.cpp:1547", "field.steps.size() != 1", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:1614", "field.steps.size() != 1 || !plain_step(step0)"),
    ("core/src/graph.cpp:1651", "field.steps.size() != 1", 'step0.name == "children"'),
    ("core/src/graph.cpp:1572", "step0.wildcard"),
    ("core/src/graph.cpp:2181", '"children" && !field.steps[0].wildcard'),
    ("core/src/graph.cpp:2259", "!field.steps[0].wildcard", 'field.steps[0].name == "subscribers"'),
    ...
    ("core/src/graph.cpp:1073", "!arena"),
    ("core/include/libtracer/segment.hpp:78", "struct segment_t"),
    # --- the design + module pages (#728). Every one of these had drifted. ---
    ("core/src/graph.cpp:781", "has_registered_child()"),
    ("core/src/graph.cpp:871", "void graph_t::fan_out"),
    ("core/src/graph.cpp:994", "graph_t::write_impl"),
    ("core/src/graph.cpp:1056", "value.materialize(*value_backend_)", "graph_t::write_branch"),
    ("core/src/graph.cpp:1057", "head.empty() && value.total_length()", "graph_t::write_branch"),
    ("core/src/graph.cpp:1069", "std::array<std::byte, 4096> stack;"),
    ("core/src/graph.cpp:1070", "bump_source_t src(stack"),
    ("core/src/graph.cpp:1072", "decode_into(head.bytes(), src)"),
    ("core/src/graph.cpp:1088", "std::vector<std::byte> root_key;"),
    ("core/src/graph.cpp:1089", "try_build_key(v, root_key)"),
    ("core/src/graph.cpp:1091", "try_assign(parse_key, root_key)"),
    ("core/src/graph.cpp:1293", "value.materialize(*value_backend_)", "field_write read it back"),
    ("core/src/graph.cpp:1526", "result_t<void> graph_t::field_write"),
    ("core/src/graph.cpp:1653", "acl_right_t::CREATE", 'step0.name == "children"'),
    ...
    ("core/include/libtracer/vertex.hpp:2413", "vertex_t* parent_"),
]
