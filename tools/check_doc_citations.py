...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2209", "graph_t::set_identity"),
    ("core/src/graph.cpp:2235", "graph_t::read_identity"),
    ("core/src/graph.cpp:2626", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:2375", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2421", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2433", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2550", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2591", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2588", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:2706", "field_selector(field) == field_sel_t::SLOT"),
...
('core/include/libtracer/graph.hpp:879',
    ...
    ('core/src/graph.cpp:2111', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2737', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/tests/CMakeLists.txt:1201', 'add_executable(substrate_test_no_atomic'),
    ('core/tests/CMakeLists.txt:1214', 'target_compile_definitions(substrate_test_no_atomic PRIVATE'),
    ...
    ('core/tests/CMakeLists.txt:1215', '    LIBTRACER_NO_ATOMIC'),
