...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2579", "graph_t::set_identity"),
    ...
    ("core/src/graph.cpp:2260", "sel == field_sel_t::TAIL", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:2379", "!whole_field(field)", 'step0.name == "acl"'),
    ("core/src/graph.cpp:2419", "field_selector(field) != field_sel_t::APPEND"),
    ("core/src/graph.cpp:2313", "sel == field_sel_t::WILDCARD"),
    ("core/src/graph.cpp:2745", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2791", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2803", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2920", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2961", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2958", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:3104", "field_selector(field) == field_sel_t::SLOT"),
    ...
    ('core/include/libtracer/graph.hpp:1492', 'std::uint64_t no_target = 0;'),
    ('core/include/libtracer/graph.hpp:1502', 'std::uint64_t denied = 0;'),
    ('core/include/libtracer/graph.hpp:1505', 'std::uint64_t out_of_memory = 0;'),
    ('core/include/libtracer/graph.hpp:1509', 'std::uint64_t fan_out_truncated = 0;'),
    ('core/include/libtracer/graph.hpp:1520', '[[nodiscard]] delivery_drops_t delivery_drops() const noexcept;'),
    ('core/include/libtracer/graph.hpp:1596', 'void fan_out(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1602', 'void dispatch_edge(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1608', 'void dispatch_edge_target(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1609', 'void dispatch_edge_remote(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1633', 'void bubble_up(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1637', 'void deliver_vertex(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:1835', 'std::pmr::memory_resource* mr_ = std::pmr::get_default_resource();'),
    ('core/include/libtracer/graph.hpp:1845', 'mem::mem_backend_t* value_backend_ = &mem::heap_backend();'),
    ('core/include/libtracer/graph.hpp:1934', 'mem::block_source_t* ctl_ = &mem::heap_source();'),
    ...
    ("core/src/graph.cpp:1176", "has_registered_child()"),
    ("core/src/graph.cpp:1293", "void graph_t::fan_out"),
    ("core/src/graph.cpp:1425", "graph_t::write_impl"),
    ("core/src/graph.cpp:1538", "value.try_materialize(*value_backend_)", "graph_t::write_branch"),
    ("core/src/graph.cpp:1540", "flatten_err_t::NO_MEMORY", "graph_t::write_branch"),
    ("core/src/graph.cpp:1555", "std::array<std::byte, 4096> stack;"),
    ("core/src/graph.cpp:1556", "bump_source_t src(stack"),
    ("core/src/graph.cpp:1558", "decode_into(head->bytes(), src)"),
    ("core/src/graph.cpp:1574", "std::vector<std::byte> root_key;"),
    ("core/src/graph.cpp:1575", "try_build_key(v, root_key)"),
    ("core/src/graph.cpp:1577", "try_assign(parse_key, root_key)"),
    ("core/src/graph.cpp:1864", "value.try_materialize(*value_backend_)",
     "field_write read an empty head"),
    ("core/src/graph.cpp:2232", "result_t<void> graph_t::field_write"),
    ("core/src/graph.cpp:2421", "acl_right_t::CREATE", 'step0.name == "children"'),
...
('core/include/libtracer/graph.hpp:1023',
    ...
    ('core/include/libtracer/graph.hpp:1925',
     '*         to migrate. Kept a DIFFERENT type from `mr_` on purpose (see'),
    ('core/include/libtracer/graph.hpp:1928',
    ...
    ('core/src/graph.cpp:905', 'graph_t::delivery_drops_t graph_t::delivery_drops() const noexcept {'),
    ('core/src/graph.cpp:912', 'void graph_t::count_drop(drop_reason_t why, std::uint64_t n) noexcept {'),
    ...
    ('core/src/graph.cpp:1664', 'if (v->listeners_above() > 0) bubble_up(v, value);', 'fan_out(v, value);'),
    ('core/src/graph.cpp:1848',
     'result_t<void> graph_t::write(vertex_handle_t v, rope_t value, std::string_view caller) {'),
    ('core/src/graph.cpp:2489', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:3135', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
