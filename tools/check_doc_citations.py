...
ANCHORS = [
    ...
    ("core/src/graph.cpp:3880",
     "result_t<void> graph_t::set_identity(std::uint8_t kind, std::span<const std::byte> key) {"),
    ("core/src/graph.cpp:3920", "result_t<view_t> graph_t::read_identity() const {"),
    ("core/src/graph.cpp:4676", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:3754", "Everything else under `settings`"),
    ("core/src/graph.cpp:3953", "result_t<view_t> graph_t::read_settings(vertex_t* v) const {"),
    ...
    ("core/src/graph.cpp:4130", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:4182", "folded_member_header(hdr_backend, body, seg.size())"),
    ("core/src/graph.cpp:4194", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:4352", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:4613", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:4610", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:4784", "field_selector(field) == field_sel_t::SLOT"),
...
('core/include/libtracer/graph.hpp:1634',
    ...
    ('core/include/libtracer/vertex.hpp:1090', '[[nodiscard]] bool has_registered_child() const noexcept {'),
    ('core/include/libtracer/vertex.hpp:1934', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:2815', 'const bool use_heap ='),
    ...
    ('core/include/libtracer/vertex.hpp:3217',
    ...
    ('core/src/graph.cpp:3763', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:4815', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/include/libtracer/vertex.hpp:518', 'enum class delivery_mode_t : std::uint8_t {'),
    ...
    ('core/include/libtracer/vertex.hpp:1988',
     'if (!pin.valid()) {  // domain exhausted: the pre-#635 path, for these threads only'),
    ('core/include/libtracer/vertex.hpp:2733',
     '*        displaced one. Call with the stripe lock held; the caller runs'),
    ('core/include/libtracer/vertex.hpp:2910', 'const std::size_t doff = off;'),
    ('core/include/libtracer/vertex.hpp:2996',
    ...
    ('core/include/libtracer/vertex.hpp:3065', '    std::atomic<role_t> role_;'),
    ...
    # core/include/libtracer/vertex.hpp
    ('core/include/libtracer/vertex.hpp:1339',
    ...
    ('core/include/libtracer/vertex.hpp:1587',
