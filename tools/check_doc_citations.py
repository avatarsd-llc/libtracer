...
ANCHORS = [
    ...
    ("core/src/graph.cpp:3785",
     "result_t<void> graph_t::set_identity(std::uint8_t kind, std::span<const std::byte> key) {"),
    ("core/src/graph.cpp:3825", "result_t<view_t> graph_t::read_identity() const {"),
    ("core/src/graph.cpp:4581", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:3659", "Everything else under `settings`"),
    ("core/src/graph.cpp:3858", "result_t<view_t> graph_t::read_settings(vertex_t* v) const {"),
    ...
    ("core/src/graph.cpp:3492", "sel == field_sel_t::WILDCARD"),
    ("core/src/graph.cpp:4035", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:4087", "folded_member_header(hdr_backend, body, seg.size())"),
    ("core/src/graph.cpp:4099", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:4257", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:4518", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:4515", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:4689", "field_selector(field) == field_sel_t::SLOT"),
    ...
    ('core/include/libtracer/mem_heap.hpp:466', '[[nodiscard]] inline std::optional<view_t> over_bytes(std::span<const std::byte> bytes,'),
    ...
    ('core/include/libtracer/graph.hpp:2525', 'void fan_out(vertex_t* v, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:2531', 'void dispatch_edge(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:2537', 'void dispatch_edge_target(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:2538', 'void dispatch_edge_remote(const edge_view_t& e, const rope_t& value);'),
    ('core/include/libtracer/graph.hpp:2562', 'void bubble_up(vertex_t* v, const rope_t& value);'),
...
('core/include/libtracer/graph.hpp:1634',
    ...
    ('core/include/libtracer/graph.hpp:2988',
     '*         LAST on purpose: no hot path reads it, so declaring it here keeps'),
    ('core/include/libtracer/graph.hpp:2826', '    mem::source_backend_t src_backend_;'),
    ('core/include/libtracer/graph.hpp:2837', '    mem::source_resource_t src_mr_;'),
    ...
    ('core/include/libtracer/mem_heap.hpp:429',
    ...
    ('core/src/graph.cpp:3668', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:4720', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/src/graph.cpp:3368', 'delivery_link.assign(split.link);'),
    ...
    ('core/tests/CMakeLists.txt:1780', 'add_executable(substrate_test_no_atomic'),
    ('core/tests/CMakeLists.txt:1795', 'target_compile_definitions(substrate_test_no_atomic PRIVATE'),
    ('core/tests/CMakeLists.txt:1796', '    LIBTRACER_NO_ATOMIC'),
    ...
    ('core/src/graph.cpp:3500', 'if (!tlv) return std::unexpected(status_t::TYPE_MISMATCH);'),
    ('core/src/graph.cpp:3671',
