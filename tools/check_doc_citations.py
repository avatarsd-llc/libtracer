...
('core/include/libtracer/graph.hpp:1058',
    ...
    ('core/include/libtracer/vertex.hpp:227',
     "* Holding one keeps that value alive, exactly as the reader's own reference did before. Under"),
    ('core/include/libtracer/vertex.hpp:232', 'class value_ref_t {'),
    ...
    ('core/include/libtracer/vertex.hpp:707', '[[nodiscard]] bool has_registered_child() const noexcept {'),
    ('core/include/libtracer/vertex.hpp:1399', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:2195', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2212', '++drops.out_of_memory;'),
    ...
    ('core/include/libtracer/vertex.hpp:372', 'enum class delivery_mode_t : std::uint8_t {'),
    ...
    ('core/include/libtracer/vertex.hpp:1457',
     'if (!pin.valid()) {  // domain exhausted: the pre-#635 path, for these threads only'),
    ('core/include/libtracer/vertex.hpp:2131',
     '*        displaced one. Call with the stripe lock held; the caller runs'),
    ('core/include/libtracer/vertex.hpp:2295', 'const std::size_t doff = off;'),
    ('core/include/libtracer/vertex.hpp:2372',
