...
('core/include/libtracer/graph.hpp:1476',
    ...
    ('core/tests/CMakeLists.txt:1689', 'add_executable(substrate_test_no_atomic'),
    ('core/tests/CMakeLists.txt:1704', 'target_compile_definitions(substrate_test_no_atomic PRIVATE'),
    ('core/tests/CMakeLists.txt:1705', '    LIBTRACER_NO_ATOMIC'),
