...
('core/include/libtracer/graph.hpp:1361',
    ...
    ('core/include/libtracer/vertex.hpp:875', '[[nodiscard]] bool has_registered_child() const noexcept {'),
    ('core/include/libtracer/vertex.hpp:1718', 'struct snapshot_drops_t {'),
    ('core/include/libtracer/vertex.hpp:2572', 'const bool use_heap ='),
    ...
    ('core/include/libtracer/vertex.hpp:1772',
     'if (!pin.valid()) {  // domain exhausted: the pre-#635 path, for these threads only'),
    ('core/include/libtracer/vertex.hpp:2490',
     '*        displaced one. Call with the stripe lock held; the caller runs'),
    ('core/include/libtracer/vertex.hpp:2667', 'const std::size_t doff = off;'),
