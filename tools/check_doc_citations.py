...
ANCHORS = [
    ...
    ("core/include/libtracer/fwd_router.hpp:881", "Terminus over a MULTI-LINK rope"),
    ("core/include/libtracer/fwd_router.hpp:887", "64 KB / 2 links"),
    ("core/include/libtracer/fwd_router.hpp:933", "The forward hop, read entirely by OFFSET"),
    ...
    ("core/src/fwd_router.cpp:2285", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:2323", "value.try_materialize(*flat_)"),
    ("core/src/fwd_router.cpp:2324", "if (!flat) return;", "A REFUSED materialize drops the delivery"),
    ("core/src/fwd_router.cpp:2326", "emit_compact", "fwd_router_t::deliver_remote"),
    ...
    ('core/include/libtracer/fwd_router.hpp:1155',
...
('core/include/libtracer/graph.hpp:1110',
    ...
    ('core/include/libtracer/fwd_router.hpp:862',
