...
ANCHORS = [
    ...
    ("core/include/libtracer/child_registry.hpp:190", "void add(std::string name"),
    ("core/include/libtracer/child_registry.hpp:438", "resolve_peer"),
    ("core/include/libtracer/child_registry.hpp:453", "bool erase"),
    ("core/include/libtracer/child_registry.hpp:479", "entry_by_name"),
    ("core/include/libtracer/child_registry.hpp:500", "by_name"),
    ("core/include/libtracer/child_registry.hpp:541", "std::size_t size()"),
    ("core/include/libtracer/child_registry.hpp:551", "live_size"),
    ...
    ("core/src/fwd_router.cpp:1353", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1381", "value.materialize(*flat_)"),
    ("core/src/fwd_router.cpp:1382", "flatten OOM"),
    ("core/src/fwd_router.cpp:1386", "try_encode_compact", "fwd_router_t::deliver_remote"),
    ("core/src/fwd_router.cpp:1418", "std::vector<std::span<const std::byte>> iov;", "fwd_router_t::deliver_remote"),
    ...
    ("core/src/fwd_router.cpp:1034", "route_flat.empty()"),
    ("core/src/fwd_router.cpp:1054", "payload_flat.empty()"),
