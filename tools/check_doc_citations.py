...
ANCHORS = [
    ...
    ("core/include/libtracer/fwd_router.hpp:360", "using reply_fn_t"),
    ("core/include/libtracer/fwd_router.hpp:371", "using stale_label_fn_t"),
    ...
    ('core/include/libtracer/fwd_router.hpp:155',
     'std::pmr::memory_resource* mr = std::pmr::get_default_resource(),'),
    ('core/include/libtracer/fwd_router.hpp:156', 'mem::block_source_t* rx = &mem::heap_source(),'),
    ...
    ('integrations/esp-idf/libtracer/httpd_ws_link.cpp:64',
     '* reply, and (the deep path) the whole /unit batch-apply transaction. The device'),
    ('integrations/esp-idf/libtracer/httpd_ws_link.cpp:71', 'constexpr std::size_t kHttpdTaskStack = 12288;'),
    ('integrations/esp-idf/libtracer/httpd_ws_link.cpp:174', 'if (chunk.empty()) return true;'),
    ('integrations/esp-idf/libtracer/httpd_ws_link.cpp:180',
