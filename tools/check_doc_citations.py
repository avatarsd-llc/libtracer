...
ANCHORS = [
    ...
    ("core/src/op_resolve_walk.hpp:926", 'field.steps[0].name != "subscribers"'),
    ...
    ('core/src/op_resolve_walk.hpp:992', 'if (!req.dst.spans_intact()) return reply_error(status_t::BACKPRESSURE);'),
...
('core/include/libtracer/graph.hpp:1164',
    ...
    ('core/src/op_resolve_walk.hpp:880',
    ...
    ('core/include/libtracer/fwd_frame_view.hpp:985', 'inline constexpr std::size_t kFwdMaxIov = 10;'),
