...
ANCHORS = [
    ...
    ("core/src/graph.cpp:2352", "graph_t::set_identity"),
    ("core/src/graph.cpp:2378", "graph_t::read_identity"),
    ("core/src/graph.cpp:2797", 'field.steps[0].name == "identity"'),
    ...
    ("core/src/graph.cpp:2033", "sel == field_sel_t::TAIL", 'step0.name == "subscribers"'),
    ("core/src/graph.cpp:2152", "!whole_field(field)", 'step0.name == "acl"'),
    ("core/src/graph.cpp:2192", "field_selector(field) != field_sel_t::APPEND"),
    ("core/src/graph.cpp:2086", "sel == field_sel_t::WILDCARD"),
    ("core/src/graph.cpp:2518", "view::segment_alloc(backend, folded_hdr_len(body_len))"),
    ("core/src/graph.cpp:2564", "folded_point_header(hdr_backend, name.size())"),
    ("core/src/graph.cpp:2576", "folded_point_header(hdr_backend, members_len)"),
    ("core/src/graph.cpp:2693", "folded_point_header(hdr_backend, n.body_len)"),
    ("core/src/graph.cpp:2734", "return read_children_folded(vh);"),
    ("core/src/graph.cpp:2731", "sel == field_sel_t::WHOLE || sel == field_sel_t::APPEND"),
    ("core/src/graph.cpp:2877", "field_selector(field) == field_sel_t::SLOT"),
    ...
    ("core/src/graph.cpp:1653", "value.try_materialize(*value_backend_)",
     "field_write read an empty head"),
    ("core/src/graph.cpp:2005", "result_t<void> graph_t::field_write"),
    ("core/src/graph.cpp:2194", "acl_right_t::CREATE", 'step0.name == "children"'),
...
('core/include/libtracer/graph.hpp:893',
    ...
    ('core/include/libtracer/vertex.hpp:2851', 'const bool use_heap ='),
    ('core/include/libtracer/vertex.hpp:2868', '++drops.out_of_memory;'),
    ...
    ('core/src/graph.cpp:1637',
     'result_t<void> graph_t::write(vertex_handle_t v, rope_t value, std::string_view caller) {'),
    ('core/src/graph.cpp:2262', 'result_t<void> graph_t::create_child(vertex_t* parent, const view_t& spec_value) {'),
    ('core/src/graph.cpp:2908', 'result_t<void> graph_t::write(const path_t& path, rope_t value) {'),
    ...
    ('core/src/graph.cpp:1991', 's.target_key.reset();'),
